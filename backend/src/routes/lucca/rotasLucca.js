...
router.get('/fralda', fraldaController.listar);
router.post('/fralda', fraldaController.criar);
router.delete('/fralda/:id', fraldaController.excluir);

router.get('/crescimento', crescimentoController.listar);
