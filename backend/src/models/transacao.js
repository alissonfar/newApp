...
const TransacaoSchema = new mongoose.Schema({
  ...
  // Quando setado, esta transação é um desembolso de Empréstimo com expectativa de
  // retorno específica. Cada gasto vinculado a um Empréstimo carrega o seu próprio
